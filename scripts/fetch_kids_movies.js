...
async function addKidsMovies() {
    console.log("Fetching hoat-hinh movies from PhimAPI...");
    // Let's get page 1, limit 30
    const listUrl = "https://phimapi.com/v1/api/danh-sach/hoathinh?page=1&limit=30";
    ...
    if (newSlugs.length > 0) {
        ...
        for (const doc of catsSnap.docs) {
            ...
            // Add all these new anime/hoathinh to the relevant categories
            if (id === 'phim-hoat-hinh' || id === 'anime-moi' || id === 'phim-bo-moi' || id === 'phim-le-hot') {
